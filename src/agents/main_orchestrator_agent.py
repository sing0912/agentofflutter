...
from src.agents.model_group.model_group_agent import model_group_agent, register_model_agents
from src.agents.controller_group.controller_group_agent import controller_group_agent, register_controller_agents
from src.agents.webview_group.webview_group_agent import webview_group_agent, register_webview_agents
...
def initialize_project(app_spec: dict, tool_context) -> dict:
    ...
    try:
        ...
        app_description = app_spec.get("description", "Flutter application generated by Agent of Flutter")
